...
import qlogo from '../assets/QSUTRA RMS LOGO - White.png'
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-purple-600 via-violet-500 to-purple-400 p-12 flex-col justify-center">
        {/* Top-left logo */}
        <div className="absolute top-6 left-6 ml-20 mr-60" >
          <img
            src={qlogo}
            alt="Top Left Logo"
        ...
        <div className="max-w-md mx-auto">
          ...
          {/* <div className="mb-6 flex justify-center">
            <img
              ...
              alt="AGI Logo"
              className="w-32 h-32" // reduced size
            />
          </div> */}

          <h1 className="text-4xl font-bold text-white mb-6">Welcome to AGI E-Log</h1>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-purple-600 mb-2">AGI USER LOGIN</h2>
