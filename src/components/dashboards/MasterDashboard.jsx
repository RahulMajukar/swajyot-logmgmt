...
import qlogo from '../../assets/QSUTRA_RMS_LOGO-White.png'
...
const MasterDashboard = ({ user, onLogout }) => {
  ...
  return (
    <div>
      ...
      <nav className="fixed top-0 left-0 w-full bg-blue-500 shadow z-50 p-4 flex justify-between items-center">
