...
const PrintingInspectionForm = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        sampleSize: '08 Nos.',
        inks: [
            { id: 1, name: 'Black Ink', weight: '', batchNo: '', expiryDate: '' },
            { id: 2, name: 'Blue Ink', weight: '', batchNo: '', expiryDate: '' },
            { id: 3, name: 'Red Ink', weight: '', batchNo: '', expiryDate: '' },
            { id: 4, name: 'White Ink', weight: '', batchNo: '', expiryDate: '' },
            { id: 5, name: 'Yellow Ink', weight: '', batchNo: '', expiryDate: '' },
            { id: 6, name: 'Green Ink', weight: '', batchNo: '', expiryDate: '' },
            { id: 7, name: '', weight: '', batchNo: '', expiryDate: '' },
                                    ...
                                    <td className="border border-gray-800 p-2">
                                        {formData.status === 'APPROVED' || !permissions.canEditInks ? (
                                            ...
                                            >
                                                ...
                                                <option value="Silver Ink">Silver Ink</option>
                                            </select>
                                        )}
                                    </td>
